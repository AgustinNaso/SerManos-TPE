  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text(
          'Novedades', 
          style: SermanosTypography.subtitle01(color: SermanosColors.primary[10]!),
        ),
        centerTitle: true,
        leading: BackButton(
          color: SermanosColors.primary[10]!,
        ),
          ...
          child: Column(
            ...
            children: [
              ...
              const Text(
                ...
                style: SermanosTypography.subtitle01(color: SermanosColors.secondary),
              ),
              const SizedBox(height: 16),
              Text( //TODO: body dynamic value
